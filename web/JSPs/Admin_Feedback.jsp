...
<html>
    ...
    <%
            ...
            ops = (OraclePreparedStatement) oconn.prepareStatement("select * from feedback");
    ...
    <body style="background-color: black">
        <h1 style="font-family: 'Comfortaa', sans-serif; margin-bottom: 3rem; font-size: 40px; color: white; text-align: center;margin-top:4rem;">Feedbacks</h1>
