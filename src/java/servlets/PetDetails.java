    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try { 
            ...
            if (rowsInserted > 0) {
                ...
                pw.println("<p style=\"color: white; text-align: center; font-size: 16px;\">Please proceed to the next page and choose a plan</p>");
                pw.println("<div style=\"text-align: center;\">");
                pw.println("<button style=\"padding: 10px 35px; border-radius: 40px; background-color: #ee6010; color: white; border-color: transparent; font-size: 15px; font-weight: 650;\" onclick=\"window.location.href='./../../Fetch-N-Flex/JSPs/subscription_fees.jsp'\">See Plans</button>");
                pw.println("</div>");
            } else {
